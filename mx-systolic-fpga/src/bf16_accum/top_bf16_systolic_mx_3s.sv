module systolic_array_MX #(
    ...
    output logic [15:0]             product[N][N],
    output logic [15:0]             odd_acc_debug[N][N],
    output logic [15:0]             even_acc_debug[N][N],
        ...
        for (i = 0; i < N; i++) begin : row
            for (j = 0; j < N; j++) begin : col
                mxfp8_mac_pe #(
                    ...
                    .product_stage1(product[i][j]),
                    .odd_acc_debug(odd_acc_debug[i][j]),
                    .even_acc_debug(even_acc_debug[i][j]),
                    .acc_reg(pe_acc[i][j])
                );
